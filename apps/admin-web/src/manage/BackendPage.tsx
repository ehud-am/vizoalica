...
/** Read-only for every role in this release: the three versions, their status, and backend health. */
export function BackendPage() {
  ...
  return (
    <div className="page backend-page" data-page="backend">
      ...
      {setupState?.principal?.role === 'admin' && (
        <p className="hint">
          Deploying and updating the backend from this console are coming in a future release. For
          now, use <code>vizoalica backend</code> from a source checkout.
        </p>
      )}
    </div>
  );
